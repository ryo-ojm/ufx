...
var gulp = require( 'gulp' ),
	scss = require( 'gulp-sass' ), //scssのコンパイル
...
gulp.task('html', function () {
	...
	return gulp.src( paths.rootDir + '/**/*.+(html|php)' )
		.pipe( gulpif( '*.html', replace( '/img', '/' + paths.serverDir + '/img' ) ) )
 ...
 * Default
 */
 /* htmlかphpかjsかcssが更新された場合はブラウザのリロード */
 /* ejsとscssファイルされた場合はejsかscssを実行 */
